...
public class FlipView extends FrameLayout {
	...
	private static final int MAX_SHADOW_ALPHA = 255;// out of 255
	private static final int MAX_SHADE_ALPHA = 255;// out of 255
	private static final int MAX_SHINE_ALPHA = 255;// out of 255
	...
	private void init() {
		...
		mShadePaint.setColor(Color.WHITE);
